...
| | |
|---|---|
| **Full title** | Probabilistic Segment-Level Triage of Ulcerative Colitis Mucosal Activity: A Bayesian Multilevel Ordinal Model Combining MR Enterography with Fecal Calprotectin |
| **First author** | Mahshad Sarikhani |
| **Venue** | ESGAR 2026, Montpellier — oral presentation |
| **Manuscript status** | *[CONFIRM: drafting / under internal review / submitted]* — medRxiv preprint planned *[CONFIRM timing]* |
| **Collaborators** | *[CONFIRM: full author list, including presenting co-authors if any]* |
| **Institution** | Department of Radiology, Shariati Hospital, Tehran University of Medical Sciences |
